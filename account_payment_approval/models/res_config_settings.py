...
class ResConfigSettings(models.TransientModel):
    ...
    # approval_company_id = fields.Many2one('res.company', string='Approval Currency',
    #                                        config_parameter='account_payment_approval.approval_company_id',
    #                                        help=" approval company id ")
